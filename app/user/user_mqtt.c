...
#define MQTT_CLIENT_SUB_TOPIC   "device/zclock/%s/set"
#define MQTT_CLIENT_PUB_TOPIC   "device/zclock/%s/state"
#define MQTT_CLIENT_SENSER_TOPIC   "device/zclock/%s/sensor"
#define MQTT_CLIENT_WILL_TOPIC   "device/zclock/%s/availability"
